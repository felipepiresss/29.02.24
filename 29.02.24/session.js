...
function enviarSessao() {
    ...
    if (sessao_digitada == null) {
        ...
        console.log(" A sessão " + txt_login.value + "foi logado com sucesso.");
    } else {
        console.error("Não foi possível enviar o Login" + txt_login.value + ", pois ja há uma sessão logada com esse login.");
}